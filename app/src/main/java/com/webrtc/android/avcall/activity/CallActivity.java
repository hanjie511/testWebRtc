...
public class CallActivity extends AppCompatActivity {
    ...
    private static final int VIDEO_RESOLUTION_WIDTH = 480;
    private static final int VIDEO_RESOLUTION_HEIGHT = 320;
    ...
    public PeerConnection createPeerConnection() {
        ...
        PeerConnection.IceServer ice_server =
                    PeerConnection.IceServer.builder("turn:turn.hanjie666.cn:3478")
                                            .setPassword("hanjie")
                                            .setUsername("hanjie")
                                            .createIceServer();
